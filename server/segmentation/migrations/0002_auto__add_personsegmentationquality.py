...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonSegmentationQuality'
        db.create_table(u'segmentation_personsegmentationquality', (
            ...
            ('segmentation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qualities', to=orm['segmentation.PersonSegmentation'])),
        ...
        db.send_create_signal(u'segmentation', ['PersonSegmentationQuality'])


    def backwards(self, orm):
        # Deleting model 'PersonSegmentationQuality'
        db.delete_table(u'segmentation_personsegmentationquality')

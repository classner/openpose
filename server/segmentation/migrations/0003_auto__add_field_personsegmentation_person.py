...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonSegmentation.person'
        db.add_column(u'segmentation_personsegmentation', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='segmentations', null=True, to=orm['pose.Person']),
                      keep_default=False)
    ...
    models = {
        ...
        u'segmentation.personsegmentation': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segmentations'", 'null': 'True', 'to': u"orm['pose.Person']"}),
        ...
        u'segmentation.personsegmentationquality': {
            ...
            'reward': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '4', 'blank': 'True'}),
            'sandbox': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'segmentations': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qualities'", 'to': u"orm['segmentation.PersonSegmentation']"}),
            'time_active_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'time_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserProfile']"})
        }

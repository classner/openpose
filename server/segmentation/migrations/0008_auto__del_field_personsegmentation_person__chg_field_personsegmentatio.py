...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonSegmentation.person'
        db.delete_column(u'segmentation_personsegmentation', 'person_id')


        # Changing field 'PersonSegmentation.task'
        db.alter_column(u'segmentation_personsegmentation', 'task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['segmentation.PersonSegmentationTask']))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'PersonSegmentation.person'
        raise RuntimeError("Cannot reverse this migration. 'PersonSegmentation.person' and its values cannot be restored.")
    ...
    models = {
        ...
        u'segmentation.personsegmentation': {
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'responses'", 'to': u"orm['segmentation.PersonSegmentationTask']"}),
            'time_active_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'time_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserProfile']"})
        },
        ...
        u'segmentation.personsegmentationtask': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'part': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),

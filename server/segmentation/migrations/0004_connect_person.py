...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ Connect to the single person instance that exists for the photo. """

        for segmentation in orm.PersonSegmentation.objects.all():
            person = segmentation.photo.persons.all()[0]

            segmentation.person = person
            segmentation.save()
    ...
    models = {
        ...
        u'segmentation.personsegmentation': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segmentation'", 'null': 'True', 'to': u"orm['pose.Person']"}),

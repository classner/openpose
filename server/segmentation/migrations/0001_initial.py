...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonSegmentation'
        db.create_table(u'segmentation_personsegmentation', (
    ...
    def backwards(self, orm):
        # Deleting model 'PersonSegmentation'
        db.delete_table(u'segmentation_personsegmentation')

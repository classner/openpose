...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonSegmentation.photo'
        db.delete_column(u'segmentation_personsegmentation', 'photo_id')


        # Changing field 'PersonSegmentation.person'
        db.alter_column(u'segmentation_personsegmentation', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pose.Person']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PersonSegmentation.photo'
        raise RuntimeError("Cannot reverse this migration. 'PersonSegmentation.photo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PersonSegmentation.photo'
        db.add_column(u'segmentation_personsegmentation', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scribbles', to=orm['photos.Photo']),
                      keep_default=False)


        # Changing field 'PersonSegmentation.person'
        db.alter_column(u'segmentation_personsegmentation', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pose.Person']))
    ...
    models = {
        ...
        u'segmentation.personsegmentation': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segmentation'", 'to': u"orm['pose.Person']"}),
            'quality_method': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'reward': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '4', 'blank': 'True'}),
            'sandbox': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonSegmentationTask'
        db.create_table(u'segmentation_personsegmentationtask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='segmentation_tasks', to=orm['pose.Person'])),
            ('parse_pose', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='segmentation_tasks', null=True, to=orm['pose.ParsePose'])),
            ('part', self.gf('django.db.models.fields.CharField')(default='P', max_length=2, null=True, blank=True)),
        ))
        db.send_create_signal(u'segmentation', ['PersonSegmentationTask'])

        # Adding field 'PersonSegmentation.task'
        db.add_column(u'segmentation_personsegmentation', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='responses', null=True, to=orm['segmentation.PersonSegmentationTask']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PersonSegmentationTask'
        db.delete_table(u'segmentation_personsegmentationtask')

        # Deleting field 'PersonSegmentation.task'
        db.delete_column(u'segmentation_personsegmentation', 'task_id')
    ...
    models = {
        ...
        u'pose.parsepose': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parse_poses'", 'to': u"orm['pose.Person']"}),
            'person_centric': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'visible_vertices': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        u'pose.person': {
        ...
        u'segmentation.personsegmentation': {
            'Meta': {'ordering': "['-time_ms']", 'object_name': 'PersonSegmentation'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invalid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mturk_assignment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['mturk.MtAssignment']"}),
            'num_scribbles': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segmentations'", 'to': u"orm['pose.Person']"}),
            'quality_method': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'reward': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '4', 'blank': 'True'}),
            'sandbox': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'responses'", 'null': 'True', 'to': u"orm['segmentation.PersonSegmentationTask']"}),
            'time_active_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'time_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserProfile']"})
        },
        u'segmentation.personsegmentationquality': {
            'Meta': {'object_name': 'PersonSegmentationQuality'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            ...
            'reward': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '4', 'blank': 'True'}),
            'sandbox': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'segmentation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qualities'", 'to': u"orm['segmentation.PersonSegmentation']"}),
            'time_active_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'time_ms': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserProfile']"})
        },
        u'segmentation.personsegmentationtask': {
            'Meta': {'ordering': "['-id']", 'object_name': 'PersonSegmentationTask'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'part': ('django.db.models.fields.CharField', [], {'default': "'P'", 'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segmentation_tasks'", 'to': u"orm['pose.Person']"}),
            'parse_pose': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'segmentation_tasks'", 'null': 'True', 'to': u"orm['pose.ParsePose']"})
        }
    }

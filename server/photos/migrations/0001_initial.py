...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoSceneCategory'
        db.create_table(u'photos_photoscenecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.PhotoSceneCategory'], null=True, blank=True)),
        ))
        db.send_create_signal(u'photos', ['PhotoSceneCategory'])
        ...
        # Adding model 'PhotoLightStack'
        db.create_table(u'photos_photolightstack', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'photos', ['PhotoLightStack'])
        ...
        db.create_table(u'photos_photo', (
            ...
            ('light_stack', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photos', null=True, to=orm['photos.PhotoLightStack'])),
            ...
            ('scene_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photos', null=True, to=orm['photos.PhotoSceneCategory'])),
            ('scene_category_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('scene_category_correct_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('scene_category_correct_method', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('whitebalanced', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('whitebalanced_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        # Adding model 'PhotoSceneQualityLabel'
        db.create_table(u'photos_photoscenequalitylabel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ...
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scene_qualities', to=orm['photos.Photo'])),
            ('correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'photos', ['PhotoSceneQualityLabel'])

        # Adding model 'PhotoWhitebalanceLabel'
        db.create_table(u'photos_photowhitebalancelabel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ('mturk_assignment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['mturk.MtAssignment'])),
            ...
            ('time_active_ms', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
            ('reward', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=4, blank=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='whitebalances', to=orm['photos.Photo'])),
            ('points', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('num_points', self.gf('django.db.models.fields.IntegerField')()),
            ('chroma_median', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('whitebalanced', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'photos', ['PhotoWhitebalanceLabel'])


    def backwards(self, orm):
        # Deleting model 'PhotoSceneCategory'
        db.delete_table(u'photos_photoscenecategory')

        # Deleting model 'FlickrUser'
        db.delete_table(u'photos_flickruser')

        # Deleting model 'PhotoLightStack'
        db.delete_table(u'photos_photolightstack')

        # Deleting model 'Photo'
        db.delete_table(u'photos_photo')

        # Deleting model 'PhotoSceneQualityLabel'
        db.delete_table(u'photos_photoscenequalitylabel')

        # Deleting model 'PhotoWhitebalanceLabel'
        db.delete_table(u'photos_photowhitebalancelabel')

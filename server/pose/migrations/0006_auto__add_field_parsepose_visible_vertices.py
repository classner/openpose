...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParsePose.visible_vertices'
        db.add_column(u'pose_parsepose', 'visible_vertices',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParsePose.visible_vertices'
        db.delete_column(u'pose_parsepose', 'visible_vertices')

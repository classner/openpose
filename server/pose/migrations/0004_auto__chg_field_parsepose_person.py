...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParsePose.person'
        db.alter_column(u'pose_parsepose', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pose.Person']))

    def backwards(self, orm):

        # Changing field 'ParsePose.person'
        db.alter_column(u'pose_parsepose', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pose.Person']))

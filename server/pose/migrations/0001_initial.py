...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParsePose'
        db.create_table(u'pose_parsepose', (
            ...
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parse_pose', to=orm['photos.Photo'])),
            ('vertices', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'pose', ['ParsePose'])


    def backwards(self, orm):
        # Deleting model 'ParsePose'
        db.delete_table(u'pose_parsepose')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParsePose.photo'
        db.delete_column(u'pose_parsepose', 'photo_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ParsePose.photo'
        raise RuntimeError("Cannot reverse this migration. 'ParsePose.photo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ParsePose.photo'
        db.add_column(u'pose_parsepose', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='parse_pose', to=orm['photos.Photo']),
                      keep_default=False)

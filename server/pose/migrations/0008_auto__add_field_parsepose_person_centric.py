...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParsePose.person_centric'
        db.add_column(u'pose_parsepose', 'person_centric',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParsePose.person_centric'
        db.delete_column(u'pose_parsepose', 'person_centric')
